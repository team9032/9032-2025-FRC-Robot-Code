...
public class MapleSimSwerveDrivetrain {
    ...
    public MapleSimSwerveDrivetrain(
        ...
        mapleSimDrive = new SwerveDriveSimulation(simulationConfig, new Pose2d(7, 3, Rotation2d.k180deg));//TODO seed starting position
        ...
        posePublisher = NetworkTableInstance.getDefault()
            .getTable("Simulation")
            .getStructTopic("Simulated Pose", Pose2d.struct)
            .publish();
    }
    ...
    public void update() {
        ...
        posePublisher.set(mapleSimDrive.getSimulatedDriveTrainPose());
    }
